...
const char KIWI_BANNER[] = 	"\x1b[2J\x1b[3J\x1b[H\r\n"
	...
	" .## ^ ##.__ _    HydraBus with HydraNFC shield v1 ( by Benjamin VERNOUX )\r\n"
	" ## / \\ /   ('>-  /***\r\n"
	" ## \\ / | K  |     Benjamin DELPY `gentilkiwi` ( benjamin@gentilkiwi.com )\r\n"
	" '## v #\\____/     *more a kiemul than a kameleon, not many leds\r\n"
	"  '#####' L\\_      ***/\r\n";
...
const KAMELEON_MODE Modes[] = {
	...
	{.function = MODE_learn,   .ledsModesBitmask = 1 << 2, .Name = "Learn", "~"},
};
/* USER CODE END 0 */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, TRF_IO0_Pin|ULED1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, D2_Pin|TRF_EN_Pin|D3_Pin|D4_Pin
                          |D5_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : TRF_IO2_Pin */
  GPIO_InitStruct.Pin = TRF_IO2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(TRF_IO2_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : TRF_IO1_Pin TRF_IO0_Pin ULED1_Pin */
  GPIO_InitStruct.Pin = TRF_IO1_Pin|TRF_IO0_Pin|ULED1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : D2_Pin TRF_EN_Pin D3_Pin D4_Pin
                           D5_Pin */
  GPIO_InitStruct.Pin = D2_Pin|TRF_EN_Pin|D3_Pin|D4_Pin
                          |D5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
